...
# 5 "E:\\embeded Sof\\pic\\include\\c99/stdlib.h" 2 3
...
# 11 "E:\\embeded Sof\\pic\\include\\c99/stdlib.h" 2 3
...
void main(void) {
    ...
    while(1){
        ...
        key=read_digital_keypad(1);
         ...
         k2=read_digital_keypad(0);

         if(k2==0x2F && control_flag!=0x01){
        ...
        else if(control_flag==0x01 && (key==0x37 || key==0x2F)&& control_flag!=0x02){
        clear_screen();
         ...
         else if(control_flag==0x03 && (key==0x1F)){
            switch(menu_pos)
            {
                case 0:
                    clear_screen();
